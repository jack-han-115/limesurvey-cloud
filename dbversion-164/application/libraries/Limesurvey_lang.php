    ...
    class Limesurvey_lang {
        ...
        function  __construct($sLanguageCode){
            ...
            else
            {
                ...
                if (file_exists(Yii::app()->getConfig('uploaddir').'/locale/'.$sLanguageCode.'/LC_MESSAGES/'.$sLanguageCode.'.mo'))
                {
                    $streamer = new FileReader(Yii::app()->getConfig('uploaddir').'/locale/'.$sLanguageCode.'/LC_MESSAGES/'.$sLanguageCode.'.mo');
                }
                else
                {
