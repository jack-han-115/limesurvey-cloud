...
<?php if (Yii::app()->getConfig("demoMode")==true)
    ...
    if (intval($iUpgradeDBVersion)<$iDestinationVersion)
    {
        ...
        { ?>
            ...
            <br><br>
                <h2><strong>New version available - upgrade now to version 5.x and get 25 free responses!</strong></h2>
                ...
                <p style='text-align:left'>We do not recommend upgrading while running active surveys. Upgrading while running active surveys may cause issues with customized templates. Also, if you use custom JavaScript in your surveys, it will probably need to be updated.</p>
            ...
            <?php echo CHtml::form(array("admin/globalsettings"), 'post', array('class'=>'form30','id'=>'frmglobalsettings','name'=>'frmglobalsettings', 'onsubmit'=>'return confirm("Are you sure you want to upgrade to version '.$sUpgradeVersion.'?");'));?>
                <p><input type='hidden' id='subaction' name='subaction' value='scheduleupgrade' /><input type='submit' value='Schedule upgrade to <?php echo $sUpgradeVersion; ?>!'/>
            </form><p>
            <?php
        }
    }
