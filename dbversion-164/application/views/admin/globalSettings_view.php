    ...
    if (intval($iUpgradeDBVersion)<$iDestinationVersion)
    {
        ...
        { ?>
            ...
            <br><br>
                ...
                <br />
                In LimeSurvey <?php echo $sUpgradeVersion; ?> there have been many improvements and survey templates are now responsive in general. It is possible to upgrade while having running surveys but existing links to your surveys will be changed by the upgrade
                and so we recommend that you only run this upgrade while not having any active surveys. If you have customized templates they will not properly work anymore. If you have used customized JavaScript it most probably will need to be adjusted.<br />
                <br />
