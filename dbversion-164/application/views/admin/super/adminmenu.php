<div class='menubar'>
    ...
    echo "<div class='menubar-title-right'><small>".sprintf($clang->gT('Your response balance: %s'),$iResponses)."</small> <a href='http://www.limeservice.com/en/buy-survey-responses'>".'(Buy more)'.'</a>
          <small>- New update (2.05+) available: </small><a href="'.$this->createUrl("admin/globalsettings").'">'.$clang->gT('Update now and get 20 free responses!').'</a>                
    </div>';
    //===============End LimeService Mod            
