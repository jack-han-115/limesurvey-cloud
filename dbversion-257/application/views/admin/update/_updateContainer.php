...
<?php if (Permission::model()->hasGlobalPermission('superadmin')): ?>
                                                            ...
                                                            if (intval($iUpgradeDBVersion)<$iDestinationVersion){
                                                                ...
                                                                if (isset($scheduleupgrade) && $scheduleupgrade){
                                                                 ...
                                                                 ?>
                                                                    <div style="width:600px;text-align: left;padding-top:50px; margin:0 auto;"><span style="font-weight: bold; font-size: 14pt;">New version available - <br />upgrade now and get 25 free responses!</span>
                                                                    <br><br>
                                                                    ...
                                                                    <p style='text-align:left'>As a bonus for upgrading, <strong>we will credit your account w</strong>s!</p>
