...
$config['allowedtemplateuploads'] = 'gif,ico,jpg,png,css,js,map,json,eot,svg,ttf,woff,woff2,txt,md,xml';  // File types allowed to be uploaded in the templates section.
