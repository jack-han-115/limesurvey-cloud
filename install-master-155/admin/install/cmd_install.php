...
if (isset($argv[1]) && $argv[1]=='install')
{
    ...
    if ($createdbtype=='mysqli') $createdbtype='mysql';
    ...
    foreach ($lines as $line) {
        ...
        if ($length and $line[0] <> '#' and substr($line,0,2) <> '--') {
            if (substr($line, $length-1, 1) == ';') {
                ...
                $command = str_replace('$defaultlang', 'auto', $command); // variables By Moses
...

{
    ...
    require ($rootdir.'/admin/admin_functions.php');
    require ($rootdir.'/classes/expressions/LimeExpressionManager.php');
    require ($rootdir.'/admin/update/upgrade-all.php');
    require ($rootdir.'/admin/update/upgrade-'.$upgradedbtype.'.php');
