...
*/
require_once($homedir.'/admin/classes/core/settingsstorage.php');
...
global $action, $editsurvey, $connect, $scriptname, $clang;
    if (isset($action) && $action == "globalsettingssave")
    {
        ...
        {                
                       ...
                       setGlobalSetting('emailmethod','smtp');
...
function globalsettingsdisplay() 
{
    ...
    if (isset($action) && $action == "globalsettings")
    {
        if($_SESSION['USER_RIGHT_SUPERADMIN'] == 1)
        {
            ...
            . "\t\t<input type='text' size='10' id='timeadjust' name='timeadjust' value=\"".htmlspecialchars(str_replace(array('+',' hours'),array('',''),getGlobalSetting('timeadjust')))."\" /> Current server time: ".date('Y-m-d H:i:s') ."</li>\n";
            ...
            $editsurvey .= "\t<div class='tab-page'> <h2 class='tab'>".$clang->gT("Email settings")."</h2><ul>\n";
                ...
                . "\t<li><label for='emailmethod'>".$clang->gT("Email method:")."</label><a href='https://www.limeservice.com/index.php?task=view&amp;id=2&amp;option=com_easyfaq&amp;Itemid=82'>SMTP</a></li>\n"
