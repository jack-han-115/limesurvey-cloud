...
// Site Info
$config['sitename']           =   'LimeSurvey Cloud - Your online survey service';     // The official name of the site (appears in the Window title)
...
$config['maxLoginAttempt']    = 6; // Lock them out after 3 attempts
$config['timeOutTime']        = 60 * 5; // Lock them out for 10 minutes.
...
*/
$config['force_ssl'] = 'on'; // DO not turn on unless you are sure your server supports SSL/HTTPS
...
$config['userquestionthemerootdir'] = $config['uploaddir'].DIRECTORY_SEPARATOR.$config['customquestionthemedir']; // The directory containing the user's question themes.
