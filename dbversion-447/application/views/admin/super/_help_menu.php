...
<li class="dropdown larger-dropdown">
    ...
    <ul class="dropdown-menu larger-dropdown" id="help-dropdown">
        ...
        <li>
            <a href="https://help.limesurvey.org/portal/en/kb/get-started/quick-start-guide" target="_blank">
        ...
        <li class="divider"></li>
        <li>
            <a href="https://help.limesurvey.org/portal/en/kb/faqs" target="_blank">
