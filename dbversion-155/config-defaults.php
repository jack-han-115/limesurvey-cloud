...
// Access data for statistics table
$statdatabasetype       =   "mysql";       // ADOdb database driver - valid values are mysql, odbc_mssql or postgres
$statdatabaselocation   =   "localhost";   // Network location of your Database - for odbc_mssql use the mssql servername, not localhost or IP
$statdatabaseport       =   "default";     // The port of your Database - if you use a standard port leave on default
$statdatabasename       =   "limeservice_statistics";  // The name of the database that we will create
$statdatabaseuser       =   "statistics";        // The name of a user with rights to create db (or if db already exists, then rights within that db)
$statdatabasepass       =   "GonAJegOFibiPIvI";            // Password of db user
...
$allowedtemplateuploads = 'gif,ico,jpg,jpe,jpeg,png,js,css';  // File types allowed to be uploaded in the templates section.
...
$emailsmtphost      =   'your.smtp.server';      // Sets the SMTP host. You can also specify a different port than 25 by using
...
$uploaddir               = "$userdir".DIRECTORY_SEPARATOR."upload";
...
$usertemplaterootdir     = "$uploaddir".DIRECTORY_SEPARATOR."templates"; // The directory path of the user templates
    ...
    $tempdir        =   "$userdir/tmp";       // The physical location where LimeSurvey can store temporary files
