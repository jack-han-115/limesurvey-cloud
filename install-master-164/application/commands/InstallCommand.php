    ...
    */
    class InstallCommand extends CConsoleCommand
    {
        ...
        public function run($sArgument)
        {
            ...
            $aAdditionalConfig=include($sConfigPath);
            $aAdditionalConfig=$aAdditionalConfig['config'];
            ...
            'users_name'=>$aAdditionalConfig['defaultuser'],
            'password'=>hash('sha256',$aAdditionalConfig['defaultpass']),
            'full_name'=>'',
            'parent_id'=>0,
            'lang'=>'auto',
            'email'=>$aAdditionalConfig['siteadminemail'],
            'create_survey'=>1,
            'participant_panel'=>1,
            'create_user'=>1,
            'delete_user'=>1,
